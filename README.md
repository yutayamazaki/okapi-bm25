...
pip install git+https://github.com/yutayamazaki/okapi-bm25.git

# Install specified commit.
pip install git+https://github.com/yutayamazaki/okapi-bm25.git@<commit-id>
```
